...
//            printMethods(classNode);
    ...
    private static void redundantInterfaces(ClassNode classNode) throws IOException
    {
        String superClassName = Type.getObjectType(classNode.superName).getClassName();
        List<String> interfaces = (List<String>) classNode.interfaces;

        System.out.println("superClassName = " + superClassName);
        System.out.println("interfaces = " + interfaces);

        Set<String> parentInterfacesSet = parentInterfaces(superClassName);

        for (String interfaceName : interfaces) {
            if (parentInterfacesSet.contains(interfaceName)) {
                System.out.println("Redundant Interface: " + interfaceName);
            }
        }

    }

    private static Set<String> parentInterfaces(String superClassName) throws IOException
    {
        ...
        while ((superClassName != null) && !superClassName.equals("java.lang.Object")) {
            ...
            List<String> interfaces = (List<String>) superClassNode.interfaces;
            interfacesSet.addAll(interfaces);
